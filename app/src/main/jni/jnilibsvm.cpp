...
extern "C" void Java_com_example_nabeo_locationhistory_jniSvmTrain(JNIEnv *env, jobject obj, jstring cmdIn){
...
extern "C" void Java_com_example_nabeo_locationhistory_PredictService_jniSvmPredict(JNIEnv *env, jobject obj, jstring cmdIn){
	const char *cmd = env->GetStringUTFChars(cmdIn, 0);
...
extern "C" void Java_com_example_nabeo_locationhistory_MainActivity_jniSvmPredict(JNIEnv *env, jobject obj, jstring cmdIn){
	const char *cmd = env->GetStringUTFChars(cmdIn, 0);
	debug("jniSvmPredict cmd = %s", cmd);
...
*/
extern "C" JNIEXPORT int JNICALL Java_com_example_nabeo_locationhistory_testInt(JNIEnv * env, jobject obj){
	return 5566;
}

extern "C" void Java_com_example_nabeo_locationhistory_testLog(JNIEnv *env, jobject obj, jstring logThis){
